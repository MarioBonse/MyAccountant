...
$fornitore=mysqli_real_escape_string($connessione, $_POST["fornitore"]);
//garantisco atomicità
mysqli_query($connessione,"BEGIN;");
$query="INSERT INTO ingredienti (Fornitore, Nome, Prezzo)
        VALUES ('".$fornitore."', '".$nome."', '".$prezzo."');"; //che abbia la parola ricercata in qualunque posizione
...
$query="INSERT INTO StoricoPrezziIngredienti (datainizio, datafine, prezzo, id)
...
print(json_encode(array('Status' => "Ingrediente inserito correttamente!")));
